...
import { listFeedback, nextFeedback, stopOutcome, transitionFeedback } from "../lib/feedback-store.mjs";
...
try {
  ...
  else if (command === "dismiss") result = transitionFeedback(root, required(id), "dismissed");
